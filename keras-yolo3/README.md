...
This `keras-yolo3` content was originally downloaded from https://github.com/experiencor/keras-yolo3

IMPORTANT! Download the (237MB) trained weights file: https://pjreddie.com/media/files/yolov3.weights

You should now have `nn_intro/keras-yolov3/yolov3.weights`
...
## Sample run sequence with the pre-trained weights

This uses the clunkily-named `yolo3_one_file_to_detect_them_all.py` which simply gives us an inference pass and annotates
the provided image with the detect boxes for objects with probability greater than 0.5.

In this example the output image will be `images/kitchen_detected.jpg`
```
python yolo3_one_file_to_detect_them_all.py  -w yolov3.weights -i images/kitchen.jpg
```
